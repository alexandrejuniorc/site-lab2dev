  ...
  return (
    <div className="rounded-md drop-shadow-[0_0_4px_rgba(134,133,133,0.5)] w-80 flex justify-around items-center flex-col p-6 bg-white">
      <div className="flex flex-col">
        ...
        <p className="font-normal text-14 leading-7 text-purple-300 not-italic text-center">
      ...
      <p className="font-normal text-14 leading-5 text-gray-800 not-italic mt-3 text-justify">
